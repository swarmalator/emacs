...
* [#C] Setup Microsoft Teams

* [#C] UPS automatic graceful shut down
...
* [#C] Migrate FileMaker Server
* [#C] Migrate all vsphere-01 VMs
* [#C] Configure phone(s)
...
* [#C] Shipping room general login
Need to not have this computer use Dwayne's login
* [#C] Low latency configuration for RDP servers?
* [#E] iDRAC
* [#F] NIST Compliance
* [#F] Domain Controller setup/migration
Learn how to configure Certificate Authorities
* [#F] Figure out AD certificates issue
